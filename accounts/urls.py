...
urlpatterns = [
    ...
    path('profile/delete_confirm/', TemplateView.as_view(template_name='accounts/delete_confirm.html' ), name='delete_confirm' ),
    ...
    path('password_reset/password_reset_email_confirm/',
         TemplateView.as_view(template_name="accounts/reset_status.html"), name='password_reset_done'),
    path('password_reset_confirm/MQ/password_reset_complete/',
         TemplateView.as_view(template_name="accounts/reset_status.html"), name='password_reset_complete'),
]
